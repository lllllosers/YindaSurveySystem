...
V1.1.1 是 V1.1.0 的维护修正版，不改变数据库结构、三级任务架构和任务/成果包协议。本次重点修复处级父任务接收后的任务分发白屏、调查录入水管所/渠系不可选问题，并完成全页面用户可见文案收口。
...
附表1.1～1.15“灌区综合与水土资源调查”在 V1.1.1 中继续保留可见预留入口和 `series_1 / comprehensive` 底层扩展能力，但当前不启用软件化录入，继续采用现行业务中的内业查档、统计整理和 Excel 汇总流程。
